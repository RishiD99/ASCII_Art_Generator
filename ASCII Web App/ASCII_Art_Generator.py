...
# path = get_valid_path()
# rf = get_valid_reduction_factor() #reduction factor
...
def gray_ascii_Generator(file_path, reduction_factor = 2):
    ...
    gray_arr, _ = image_processing(file_path, rf)
...
def color_ascii_Generator(file_path, reduction_factor = 2):
    ...
    gray_arr, img_arr = image_processing(file_path, rf)
